...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1231456027);
user_pref("app.update.lastUpdateTime.background-update-timer", 1231456027);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1231456027);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1231456028);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1231456028);
user_pref("browser.cache.disk.capacity", 10000);
user_pref("browser.cache.disk.parent_directory", "/tmp/mozilla-cache");
...
user_pref("extensions.autohide.bars.statBar", false);
...
user_pref("extensions.enabledItems", "langpack-en-GB@firefox-3.0.ubuntu.com:3.0.3,ntvfullscreen@neurostechnology.com:1.1,nosquint@urandom.ca:1.93.2.1,ubufox@ubuntu.com:0.6,langpack-en-GB@xulrunner-1.9.ubuntu.com:1.9.0.3,{972ce4c6-7e08-4474-a285-3208198ce6fd}:3.0.6,neurostv-theme@neurostechnology.com:1.1");
user_pref("extensions.lastAppVersion", "3.0.6");
user_pref("extensions.nosquint.exceptions", "*/~* *.sourceforge.net *.google.[*]");
user_pref("extensions.nosquint.forgetMonths", 12);
user_pref("extensions.nosquint.sites", "hulu.com=120,1236107237108,1,0");
user_pref("extensions.nosquint.wheelZoomEnabled", true);
user_pref("extensions.nosquint.zoomlevel", 110);
user_pref("extensions.update.notifyUser", false);
user_pref("font.minimum-size.x-western", 16);
user_pref("font.size.fixed.x-western", 16);
user_pref("general.skins.selectedSkin", "NeurosTV");
user_pref("intl.charsetmenu.browser.cache", "UTF-8, ISO-8859-1");
user_pref("layout.css.dpi", 0);
user_pref("mousewheel.withcontrolkey.action", 5);
